...
APP_ID = int(os.environ.get("APP_ID", "26375136"))

#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "975c7f22f108ec1635d85ad3e05d705b")

#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002325099656"))
